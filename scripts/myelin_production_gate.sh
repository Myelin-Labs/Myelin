...
for settlement, verify, court, da, kind in ((settlement_static, settlement_verify_static, court_static, da_static, "static-closed-committee"),
    ...
    require(economics["mode"] == "disputed-close-policy-commitment", f"{kind} court economics mode")
    ...
    require(economics["testnet_beta_ready"] is False, f"{kind} court economics is commitment-only, not testnet-beta ready")
