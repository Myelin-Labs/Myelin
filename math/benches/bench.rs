...
use myelin_math::{construct_uint, Uint3072};
...
fn bench_uint128(c: &mut Criterion) {
    ...
    let shifts: Vec<_> = (0..ITERS_128).map(|_| rng.next_u32() % 128).collect();
    ...
    bench_op(&mut u128_c, &u128_one, &u128_two, |a, b| a / b.max(1), "division");
    bench_op(&mut u128_c, &u128_one, &u64s, |a, b| a / (b as u128).max(1), "u64 division");
    ...
    bench_op(&mut uint128_c, &uint128_one, &u64s, |a, b| a.overflowing_add_u64(b).0, "addition u64");
    bench_op(&mut uint128_c, &uint128_one, &uint128_two, |a, b| a.overflowing_mul(b).0, "multiplication");
    bench_op(&mut uint128_c, &uint128_one, &u64s, |a, b| a.overflowing_mul_u64(b).0, "multiplication u64");
    bench_op(&mut uint128_c, &uint128_one, &uint128_two, |a, b| if b.is_zero() { a } else { a / b }, "division");
    bench_op(&mut uint128_c, &uint128_one, &u64s, |a, b| a / b.max(1), "u64 division");
    bench_op(&mut uint128_c, &uint128_one, &shifts, |a, b| a.overflowing_shl(b).0, "left shift");
    bench_op(&mut uint128_c, &uint128_one, &shifts, |a, b| a.overflowing_shr(b).0, "right shift");
    uint128_c.finish();
}
...
fn bench_uint256(c: &mut Criterion) {
    ...
    let uint256_two: Vec<_> = (0..ITERS_256)
        ...
        .collect();
    let shifts: Vec<_> = (0..ITERS_256).map(|_| rng.next_u32() % 256).collect();
    ...
    bench_op(&mut uint256_c, &uint256_one, &u64s, |a, b| a.overflowing_add_u64(b).0, "addition u64");
    bench_op(&mut uint256_c, &uint256_one, &uint256_two, |a, b| a.overflowing_mul(b).0, "multiplication");
    bench_op(&mut uint256_c, &uint256_one, &u64s, |a, b| a.overflowing_mul_u64(b).0, "multiplication u64");
    bench_op(&mut uint256_c, &uint256_one, &uint256_two, |a, b| if b.is_zero() { a } else { a / b }, "division");
    bench_op(&mut uint256_c, &uint256_one, &u64s, |a, b| a / b.max(1), "u64 division");
    bench_op(&mut uint256_c, &uint256_one, &shifts, |a, b| a.overflowing_shl(b).0, "left shift");
    bench_op(&mut uint256_c, &uint256_one, &shifts, |a, b| a.overflowing_shr(b).0, "right shift");
    uint256_c.finish();
}
...
fn bench_uint3072(c: &mut Criterion) {
    ...
    let uint3072_two: Vec<_> = (0..ITERS_3072)
        ...
        .collect();
    let shifts: Vec<_> = (0..ITERS_3072).map(|_| rng.next_u32() % 3072).collect();
    ...
    bench_op(&mut uint3072_c, &uint3072_one, &u64s, |a, b| a.overflowing_add_u64(b).0, "addition u64");
    bench_op(&mut uint3072_c, &uint3072_one, &uint3072_two, |a, b| a.overflowing_mul(b).0, "multiplication");
    bench_op(&mut uint3072_c, &uint3072_one, &u64s, |a, b| a.overflowing_mul_u64(b).0, "multiplication u64");
    bench_op(&mut uint3072_c, &uint3072_one, &uint3072_two, |a, b| if b.is_zero() { a } else { a / b }, "division");
    bench_op(&mut uint3072_c, &uint3072_one, &u64s, |a, b| a / b.max(1), "u64 division");
    bench_op(&mut uint3072_c, &uint3072_one, &shifts, |a, b| a.overflowing_shl(b).0, "left shift");
    bench_op(&mut uint3072_c, &uint3072_one, &shifts, |a, b| a.overflowing_shr(b).0, "right shift");
