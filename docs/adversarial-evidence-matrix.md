...
|---|---|---|---|
| Court bundle binding | `teeworlds_court_bundle_is_single_chunk_projectable`, `teeworlds_court_bundle_weighted_precommit_path_verifies` | `session_court_bundle_rejects_tampered_state_root` | Covered for fixture court bundles. |
...
| Runtime smoke | `runtime_smoke_static_closed_committee_finalises_a_block`, `runtime_smoke_weighted_precommit_finalises_a_block`, `runtime_smoke_state_is_consensus_agnostic_but_certificates_differ` | `runtime_smoke_rejects_unknown_consensus_kind` | Covered for CLI runtime wiring. |
